...
public class BMIActivityColor extends AppCompatActivity {
...
//        nx=findViewById(R.id.nhan_xet);
        ...
        viewModel.getLoggedStatus().observe(this, new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if (aBoolean ){
                    Intent myIntent = new Intent(BMIActivityColor.this, LoginActivity.class);
...
//        logout.setOnClickListener(this::onClick);
    ...
    public void insertBmi(){
        ...
        Intent myIntent = new Intent(BMIActivityColor.this, BMIActivity.class);
